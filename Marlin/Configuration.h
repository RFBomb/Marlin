...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  34.86,  22.20 }
    #define DEFAULT_Ki_LIST {   3.64,   1.08 }
    #define DEFAULT_Kd_LIST { 83.35, 114.00 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.6, 80, 403, 97.38 }
 ...
 *     O-- FRONT --+
 */
#define ProbeOffset_X -41.4 //Being used for determining the MESH_MAX_XY values in Configuration_adv.h
#define ProbeOffset_Y -14.0
#define NOZZLE_TO_PROBE_OFFSET { ProbeOffset_X, ProbeOffset_Y, -1.45 }
